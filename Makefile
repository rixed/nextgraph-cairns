...
.PHONY: all help install build run dev test check orm e2e e2e-m1 e2e-m2 e2e-m3 seed-media seed-clips clean
...
help:
	...
	@echo '         e2e-m1 / e2e-m2 / e2e-m3 for one of them. Needs the devstack up'
