...
export const mediaShapeSchema = {
  ...
  "did:ng:z:cairns/VideoShape": {
    iri: "did:ng:z:cairns/VideoShape",
    predicates: [
      {
        dataTypes: [
          {
            valType: "iri",
            literals: ["https://schema.org/VideoObject"],
          },
        ],
        maxCardinality: 1,
        minCardinality: 1,
  ...
  "did:ng:z:cairns/AudioShape": {
    iri: "did:ng:z:cairns/AudioShape",
    predicates: [
      {
        dataTypes: [
          {
            valType: "iri",
            literals: ["https://schema.org/AudioObject"],
          },
        ],
        maxCardinality: 1,
        minCardinality: 1,
